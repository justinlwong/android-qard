...
public enum Services {
	...
	TWITTER("Twitter", 6, R.drawable.twitter, R.drawable.twitter_gray, "id_str", "http://api.twitter.com/", "https://api.twitter.com/1.1/account/verify_credentials.json", "ZtN4h8Ps9cyNIadDK6cg", "RCE4Gls0cKcdpe19VYLOC4rg7zHcgV0n5f6rPnaV4VU", "oauth://twitter", null, "https://api.twitter.com/1.1/friendships/create.json"),
	...
	INSTAGRAM("Instagram", 10, R.drawable.instagram, R.drawable.instagram_gray, "id", "http://api.instagram.com/", "https://api.instagram.com/v1/users/self/?access_token=", "b4ff6552928a495a983827d421a09473", "4f2ec0d2154541da9cd158b42752f706", "oauth://instagram", "basic", null),
	LINE("Line", 11, R.drawable.line, R.drawable.line_gray, null, null, null, null, null, null, null, null),
	LINKEDIN("LinkedIn", 12, R.drawable.linkedin, R.drawable.linkedin_gray, "id", "http://api.linkedin.com/", "http://api.linkedin.com/v1/people/~:(id,first-name,last-name,industry,email-address,site-standard-profile-request)?format=json", "a3dolo9iq9fd", "hKyo855beQ9ggLXZ","oauth://linkedin","r_fullprofile r_emailaddress w_messages", "http://api.linkedin.com/v1/people/~/mailbox"),
